...
namespace OnlineQRMenuApp.Controllers
{
    public class OrdersController : BaseController
    {
        ...
        public OrdersController(IWebHostEnvironment env, IConfiguration configuration, OnlineCoffeeManagementContext context) : base(env, configuration)
        {
            _context = context;
        }
        ...
        {
            var onlineCoffeeManagementContext = _context.Orders.Include(o => o.CoffeeShop).Include(o => o.User);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,CoffeeShopId,OrderDate,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,UserId,CoffeeShopId,OrderDate,Status")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
