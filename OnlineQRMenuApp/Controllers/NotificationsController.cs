...
namespace OnlineQRMenuApp.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var onlineCoffeeManagementContext = _context.Notifications.Include(n => n.User);
        ...
        public async Task<IActionResult> Create([Bind("NotificationId,UserId,Message,SentDate,IsRead")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NotificationId,UserId,Message,SentDate,IsRead")] Notification notification)
        {
